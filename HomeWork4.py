...
def writeTexFile(texdoc, path):  # write back the new document
...
def task1():
    ...
    filename = str(input())
    # 'C:/Users/Pavel/Desktop/python_hw/HW - 04'
    # read the .tex file, and modify the lines
    doc = readTexFile(path + filename)  # a list of string representing the latex document in python
    a = conjecturer(doc)
    writeTexFile(a, path + 'conjectured.tex')
    createDocx(docxStructure(doc))
    # increaseFontsize('C:/Users/Pavel/Desktop/python_hw/HW - 04/ifacconf.cls', 'C:/Users/Pavel/Desktop/python_hw/HW - 04/ifacconf1.cls')
    struc = getStyle(doc)
